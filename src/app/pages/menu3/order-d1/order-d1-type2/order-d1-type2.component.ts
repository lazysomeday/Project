...
@Component({
  selector: 'app-order-d1-type2',
  templateUrl: './order-d1-type2.component.html',
  styleUrls: ['./order-d1-type2.component.css']
})
export class OrderD1Type2Component implements OnInit {
