...
@Component({
  selector: 'app-order-d1-type1',
  templateUrl: './order-d1-type1.component.html',
  styleUrls: ['./order-d1-type1.component.css']
})
export class OrderD1Type1Component implements OnInit {
