...
@Component({
  selector: 'app-order-d1-type3',
  templateUrl: './order-d1-type3.component.html',
  styleUrls: ['./order-d1-type3.component.css']
})
export class OrderD1Type3Component implements OnInit {
