...
export class EditProfileComponent implements OnInit {
  ...
  constructor(private global: GlobalService, private afAuth: AngularFireAuth, private api: UserService,
    private router: Router) {
     }

  ngOnInit() {
    this.afAuth.authState.subscribe(data => {
    this.api.showMemberByEmail(data.email).subscribe(snap => {
  ...
  onEdit_profile(key, dd: NgForm) {
    ...
    this.api.editData(key, dd.value).subscribe();
    this.ngOnInit();
    swal({
      title: 'สำเร็จ!',
